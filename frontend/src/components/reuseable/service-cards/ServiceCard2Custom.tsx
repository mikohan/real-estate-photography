...
const ServiceCard2Custom: FC<ServiceCard2Props> = (props) => {
...
// set deafult Props
ServiceCard2Custom.defaultProps = { iconBoxClassNames: 'icon btn btn-circle btn-lg btn-primary pe-none mb-5' };

export default ServiceCard2Custom;
